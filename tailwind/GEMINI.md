...
This project uses **Tailwind CSS** for all its styling needs. It adheres to a utility-first approach, emphasizing rapid UI development and consistent design through configuration.

## Key Instructions & Guidelines:

*   **General Instructions**: See `.gemini-guidelines/overview.md` for core principles and tasks.
*   **Theming**: See `.gemini-guidelines/theming.md` for extending and customizing the Tailwind CSS theme.
*   **Utility Class Patterns**: See `.gemini-guidelines/utility-class-patterns.md` for best practices in applying Tailwind utility classes.